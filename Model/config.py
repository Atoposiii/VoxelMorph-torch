...
"""
import argparse
# 创建了一个ArgumentParser对象，用于定义和解析命令行参数
parser = argparse.ArgumentParser()

# 公共参数
parser.add_argument("--gpu", type=str, help="gpu id",
                    dest="gpu", default='0')
parser.add_argument("--atlas_file", type=str, help="file path",
...
parser.add_argument("--n_save_iter", type=int, help="frequency of model saves",# 每隔多少次迭代保存一次模型
